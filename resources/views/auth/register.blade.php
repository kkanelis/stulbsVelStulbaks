<x-layout title="Register">
    <div style="min-height: 100vh; display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, #0F4C75 0%, #3282B8 100%); position: relative; overflow: hidden; padding: 2rem;">
        ...
        <div style="width: 100%; max-width: 500px; position: relative; z-index: 1;">
            <div style="background: white; padding: 3rem; border-radius: 20px; box-shadow: 0 20px 60px rgba(27, 38, 44, 0.3);">
                <!-- Header -->
                <div style="text-align: center; margin-bottom: 2.5rem;">
                    <h1 style="color: #0F4C75; margin: 0 0 0.5rem 0; font-size: 2rem; font-weight: 800;">Reģistrēties</h1>
                    <p style="color: #999; margin: 0; font-size: 0.95rem;">Izveidojiet savu jauno kontu un sāciet mācīties</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div style="margin-bottom: 1.5rem;">
                        <label style="display: block; margin-bottom: 0.6rem; font-weight: 600; color: #1B262C;">👤 Pilns Vārds</label>
                    ...
                    <div style="margin-bottom: 2rem;">
                        <label style="display: block; margin-bottom: 0.6rem; font-weight: 600; color: #1B262C;">✓ Apstiprināt Paroli</label>
                    ...
                    <div style="text-align: center; margin-top: 1.5rem; color: #999; font-size: 0.95rem;">
                        Jau ir konts? 
                        <a href="{{ route('login.show') }}" style="color: #0F4C75; text-decoration: none; font-weight: 700; transition: color 0.3s ease;"
